    ...
    async def send_voice(
        ...
        **kwargs,
        ...
        try:
            ...
            audio_bytes = await _read_file_async(audio_path)
    ...
    async def send_image_file(
        ...
        **kwargs,
        ...
        try:
            ...
            image_bytes = await _read_file_async(image_path)
    ...
    async def send_document(
        ...
        **kwargs,
        ...
        try:
            ...
            file_bytes = await _read_file_async(file_path)
    ...
    async def send_video(
        ...
        **kwargs,
        ...
        try:
            ...
            video_bytes = await _read_file_async(video_path)
